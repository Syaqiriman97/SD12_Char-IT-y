<?php
	...
	{	
		...
		{
            echo "<center><h3><script>alert('Sorry.. This IC Number is already registered !!');</script></h3></center>";
            header("refresh:0;url=login.php");
        }
		else
		{
            $str="insert into user set name='$name',email='$email',password='$password',phonenumber='$phonenumber',roles='$roles'";
			...
			<div class="container">
				<div class="box-wrapper">				
					<div class="box box-border">
						<div class="box-body">
							<center> <h5 style="font-family: Noto Sans;">Register to </h5><h4 style="font-family: Noto Sans;">Char-IT-y</h4></center><br>
							<form method="post" action="register.php" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label>Enter your IC Number Id:</label>
